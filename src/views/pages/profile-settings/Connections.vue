...
<template>
  <div>
    <VCard title="One-Click Connections">
      <VCardText>
        <VRow>
          <VCol
            cols="12"
            ...
            >
              <VCardText>
                <VList class="card-list">
                  <VListItem
                    v-for="connection in connectionsAccounts"
                    :key="connection.title"
                  >
                    <template #prepend>
                      <VAvatar size="28">
                        <VImg :src="connection.avatarImg" />
                      </VAvatar>
                    </template>
                    ...
                    <VListItemSubtitle class="text-muted">
                      {{ connection.sub_title }}
                    </VListItemSubtitle>

                    <template #append>
                      <VSwitch v-model="connection.connected" />
                    </template>
                  </VListItem>
                </VList>
              </VCardText>
          ...
          >
            ...
            >
              <VCardText>
                <VList class="card-list">
                  <VListItem
                    v-for="connection in socialAccounts"
                    :key="connection.title"
                  >
                    <template #prepend>
                      <VAvatar size="28">
