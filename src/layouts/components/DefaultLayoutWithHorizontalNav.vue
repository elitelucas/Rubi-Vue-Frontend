...
const darkNode = h('div', { innerHTML: logoDark, style: 'line-height:0; color: rgb(var(--v-global-theme-primary))' })
</script>
...
<template>
  <HorizontalNavLayout :nav-items="navItems">
    ...
    <template #navbar>
      ...
      >
        <VNodeRenderer :nodes="theme.global.current.value.dark ? darkNode : themeConfig.app.logo" />
      </RouterLink>
      <VCol :lg="3">
        <AppSelect
          v-model="workspace"
